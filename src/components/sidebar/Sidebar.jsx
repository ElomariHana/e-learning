      ...
      <div className="sidebar-body">
        <div className="sidebar-menu">
          ...
          <li className="menu-item">
            ...
            {userRole === 'student' && (
            <li className="menu-item">
              <Link to="/profile/enrolled-courses" className={`menu-link ${isActive('/profile/enrolled-courses') ? 'active' : ''}`}>
                <span className="menu-link-icon">
                  <MdCastForEducation size={20} />
                </span>
            ...
            {userRole === 'student' && (
            <li className="menu-item">
              <Link to="/profile/available-courses" className={`menu-link ${isActive('/profile/available-courses') ? 'active' : ''}`}>
                <span className="menu-link-icon">
